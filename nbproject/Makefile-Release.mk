...
${OBJECTDIR}/Command/CommandData.o: Command/CommandData.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Command/CommandData.o Command/CommandData.cpp

${OBJECTDIR}/Command/ICommand.o: Command/ICommand.cpp 
	${MKDIR} -p ${OBJECTDIR}/Command
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Command/ICommand.o Command/ICommand.cpp

${OBJECTDIR}/Command/OriginalCommand.o: Command/OriginalCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}/Command
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Command/OriginalCommand.o Command/OriginalCommand.cpp
...
${OBJECTDIR}/game/command.o: game/command.cpp 
	${MKDIR} -p ${OBJECTDIR}/game
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/game/command.o game/command.cpp
